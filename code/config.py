...
__C.TRAIN.USE_PREV_CONTROL = True
__C.TRAIN.PATIENCE = 5
__C.TRAIN.VAR_DROPOUT = False
__C.TRAIN.CLEVR_DIALOG = False
__C.TRAIN.USE_CONTEXT_WEMBS = False
__C.TRAIN.USE_QUERY_PROJ = False
